...
# Opción 2: generamos series de tiempo sin tener en cuenta la pertenencia al día anterior. Pueden incluir medidas pertenecientes a varios días si la técnica se mide con baja frecuencia, y en ese caso el estado CTRL siempre estará referido al último valor de la serie temporal. 
...
batch_size <- 10000 # Tamaño de batch.
