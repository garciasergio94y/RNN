...
## Selección opcional de pruebas.

```{r}
data_sel_tr %<>% subset(CODIGO_PRUEBA == "CLC00638" | # Procalcitonina
                        CODIGO_PRUEBA == "CLC02816") # Troponina
```
...
# Capa de salida con una unidad de activación lineal para la predicción:  
  ...
  model <- 
    ...
    compile(
      optimizer = optimizer_adam(learning_rate = 0.00004),
      loss      = loss_sigmoid_focal_crossentropy(alpha = 0.1, 
                                         gamma = 5, 
